...
public class PM implements IInstaller {
     ...
     *                           java.lang.String packageAbiOverride) throws android.os.RemoteException;
     *                           <p/>
     *                           <p/>
     *                           Android 5.0.0
     *                           public void installPackage(
     ...
     *                           int flags,
     *                           java.lang.String installerPackageName) throws android.os.RemoteException;
     *                           <p/>
     *                           <p/>
     *                           Android 4.3.1
     *                           public void installPackage(
     ...
     */
    @Override
    public void installPackage(String s, IInstallerCallback iInstallerCallback) {
        try {
            if (Build.VERSION.SDK_INT > Build.VERSION_CODES.KITKAT) {
            	L.i( "zdy  sdk > 19");
                installPackageHighApi(s, iInstallerCallback);
            } else {
                installPackageLowApi(s, iInstallerCallback);
                L.i( "zdy  sdk  <= 19");
            }
        } catch (Exception e) {
             
        	L.i( "installPackage  error = " + e.toString());
// 小米note 6.0   java.lang.SecurityException: Neither user 10175 nor current process has android.permission.INSTALL_PACKAGES.
    ...
    private void installPackageHighApi(final String path, final IInstallerCallback iInstallerCallback) throws Exception {
        ...
        getIPackageManager().installPackage(path, observer, flags, null,  verificationParams, null);  // aidl
    }
    ...
    private void installPackageLowApi(String path, final IInstallerCallback iInstallerCallback) throws Exception {
        ...
        RefInvoke.invokeMethodWithException(ipm.getClass(), "installPackage", ipm,
                new Class[]{Uri.class, IPackageInstallObserver.class, int.class, String.class},
                new Object[]{uri, observer, flags, null});
    }
    ...
    private IPackageManager getIPackageManager() {
        IBinder iBinder = (IBinder) RefInvoke.invokeStaticMethod("android.os.ServiceManager",
                "getService", new Class[]{String.class}, new Object[]{"package"});
    ...
    class PackageInstallObserver2 extends IPackageInstallObserver2.Stub {
        ...
        public void onPackageInstalled(String basePackageName, int returnCode, String msg, Bundle extras) throws RemoteException {
        	 L.i( "PackageInstallObserver2.onPackageInstalled pkg : " + basePackageName + "  returnCode : " + returnCode);
            if (callback != null) callback.finishInstall(returnCode);
        }
    }
    ...
    class PackageInstallObserver extends IPackageInstallObserver.Stub {
        ...
        public void packageInstalled(String packageName, int returnCode) throws RemoteException {
        	L.i( "PackageInstallObserver.packageInstalled pkg : " + packageName + "  returnCode : " + returnCode);
            if (callback != null) callback.finishInstall(returnCode);
        }
    }
}
