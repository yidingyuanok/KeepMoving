...
public class NetWorkUtils {
    ...
    public static boolean isWifiActive(Context context) {
        ...
        return ninfo != null && ninfo.isAvailable() && ninfo.getType() == ConnectivityManager.TYPE_WIFI && ninfo.getDetailedState() == NetworkInfo.DetailedState.CONNECTED;
    }
    ...
    public static boolean isMobleActive(Context context) {
        ...
        ConnectivityManager cm = (ConnectivityManager) context.getSystemService(Context.CONNECTIVITY_SERVICE);
        NetworkInfo ninfo = cm.getActiveNetworkInfo();
        return ninfo != null && ninfo.isAvailable() && ninfo.getType() == ConnectivityManager.TYPE_MOBILE && ninfo.getDetailedState() == NetworkInfo.DetailedState.CONNECTED;
    }
